...
?>
    ...
    <body>
        ...
        <div class="container mt-3 pt-4 shadow min-vh-50 py-2 col-10" style="background-color: whitesmoke; border: 1px solid #ddd; border-radius: 8px; padding: 15px;">
            <a class="btn mb-3 btn-sm rounded-pill bg-secondary text-white" href="<?php echo ($_SESSION['userlevel'] == '3') ? 'search_activity.php' : 'search_activity.php'; ?>" role="button">ย้อนกลับ</a>
        ...
        ORDER BY registrations.registration_time ASC";
            ...
            ?>
                ...
                <div class="text-black">
                    ...
                    <p>ชื่อผู้จัดกิจกรรม: <?php echo $organizerName; ?> <br> เบอร์โทรศัพท์ <?= $activityDetails['telNumber']; ?> <br>
                        ได้รับการลดชั่วโมงเป็นจำนวน <?= $activityDetails['hours']; ?> ชั่วโมง </p>
